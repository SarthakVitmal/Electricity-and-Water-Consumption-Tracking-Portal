<?php
    ...
    if (isset($_POST['Submit'])) {
        ...
        $sql = $sql = "INSERT INTO  user_electricityform_credentials (persons, energy_efficient_appliances, heating_cooling, laundry_frequency, turn_off_lights, lighting_type, solar_panels, unplug_electronics, units_consumped, device_name, quantity, duration, device_name2, quantity2, duration2, device_name3, quantity3, duration3) 
