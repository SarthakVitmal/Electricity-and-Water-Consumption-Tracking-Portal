<?php
    ...
    if (!$conn) {
        ...
        if (isset($_POST['Submit'])) {
            ...
            $sql = "INSERT INTO `user_waterform_credentials` (`persons`, `fix_faucets`, `water_supply`, `shower`, `shower_frequency`, `bucket_number`, `machine_runtime`, `utensils`, `house_cleaning`, `tap_while_brushing`, `water_efficient_appliances`, `rainwater_harvesting`) 
